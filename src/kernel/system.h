...
// Custom types
typedef unsigned char uint8;    // 8-bit unsigned integer, range: 0 to 255
typedef unsigned short uint16;  // 16-bit unsigned integer, range: 0 to 65,535
typedef unsigned int uint32;    // 32-bit unsigned integer, range: 0 to 4,294,967,295
